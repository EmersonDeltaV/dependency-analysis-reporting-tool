...
public class CurrentFormatWorkbookCharacterizationTests
{
    ...
    {
        var generatorType = GetRequiredType("DART.ReportGenerator.Services.ReportGenerator");
    ...
    public void ApplyComparison_ShouldCarryOverReviewColumns_AndMarkFoundInPreviousScan()
    {
        ...
        var comparisonServiceType = GetRequiredType("DART.ReportGenerator.Services.WorkbookComparisonService");
